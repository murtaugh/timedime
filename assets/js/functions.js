...
$(document).ready(function (){
	...
	ns=$.initNamespaceStorage('timedime');
	...
	$('[data-projectobject]').each(function() {

		whichTextarea = $(this).attr('data-projectobject');

		whichValue = $(this).val();

		if (storage.isSet(whichTextarea)) {

			$(this).attr('value', storage.get(whichTextarea)).html(storage.get(whichTextarea));

		} else {

			storage.set(whichTextarea, whichValue);
	...
	$('[data-deleteall]').on('click', function() {
...
storeThisValue = function(which) {

	whichField = which.attr('data-projectobject');
	whichVal = which.val();
	storage.set(whichField, whichVal);

};

clearAllFields = function() {

	$('[data-projectobject]').attr('value', '').html('');
